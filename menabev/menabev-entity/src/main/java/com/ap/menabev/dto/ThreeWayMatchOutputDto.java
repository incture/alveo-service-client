...
@Setter
@ToString
public class ThreeWayMatchOutputDto {
	private String guid;
	...
	private String invoicePdfId; // add the document id of the invoice pdf to
									// show in oepn pdf .
	...
	private Long invoiceDate;// added for the tag in xml _InvoiceDate as
								// discussed.
	...
	private List<ThreeWayInvoiceItemDto> invoiceItems;
